...
import { FaAtlassian, FaHome, FaMastodon, FaPlus, FaTasks } from 'react-icons/fa';
...
const SideNavbar = () => {
      return (
            ...
            <Link to={'/'}>
                <h2 className='cursor-pointer font-bold p-4 flex items-center justify-center text-3xl'><FaAtlassian /></h2>
            </Link>
